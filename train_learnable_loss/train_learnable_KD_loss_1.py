...
def main(args):
    ...
    channel, im_size, num_classes, train_loader, _, test_loader = get_dataset(dataset=args.dataset,
    ...
    ''' training '''
    kd_loss = LearnableKDLoss(num_classes=num_classes).to(args.device)
    kd_loss.train()
    ...
    for epoch in range(args.Epochs):
        ...
        for step in range(args.update_student_params_steps):
            ...
            loss, weight, T = kd_loss(logit_1, logit_2)
            # print("weight:{},\n T:{}".format(weight, T))
        ...
        nn.utils.clip_grad_norm_(kd_loss.parameters(), 0.5)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--Epochs', type=int, default=500, help='how many distillation steps to perform')
    ...
    parser.add_argument('--update_student_params_steps', type=int, default=40, help='how many steps to take on val data')
