...
parser.add_argument('--kd-loss-ema', action='store_true', default=False,
                    help='Enable tracking moving average of model weights')
parser.add_argument('--kd-loss-ema-decay', type=float, default=0.99,
                    help='decay factor for model weights moving average (default: 0.9998)')
...
parser.add_argument('--kd_opt', type=str, default='sgd',
                    help='optimizer used in learnable kd loss. ')
parser.add_argument('--kd_lr', type=float, default='1e-3')
parser.add_argument('--kd_opt_eps', type=float, default='1.0e-08')
parser.add_argument('--kd_momentum', type=float, default='0.9')
parser.add_argument('--kd_weight_decay', type=float, default='1e-4')
parser.add_argument('--update_student_params_steps', type=int, default='50')
